...
export const setMetaNOV23 = ref(
  {
    setCode: 'NOV23',
    setName: 'November Releases 2023',
    setDescription: 'Beginning in November 2023, it was decided to begin releasing sets by month, this is the first set to do that',
    setSize: 7,
  },
)
